...
| **Necronquista** | 🎮 Jogos / Simulação | C, Listas Encadeadas, Persistência, Windows API | Estratégia de necromancia com interface de console avançada. Utiliza alocação dinâmica (malloc/free) para gerenciar exércitos e salva progresso binário. | [📂 Ver Projeto](./Projeto_Necronquista) |
